...
def media1(lista):
    ...
    for e in lista:
        resposta = resposta + e
    return resposta/len(lista)

# retornando a media em uma lista
def media2(lista):
...
#PARAR DE RODAR O TESTE. Comenta a função runTests()
# depois cria os prints no final do código para ver o resultado da sua função
#runTests()